...
public class BossSecondEvocation : BossBase
{
    /// <summary>
    /// 공중으로 날거나 착지하는 시간
    /// </summary>
    ...
    IEnumerator EvocationCoroutine(BossController sender)
    {
        ...
        // 마지막 광범위한 공격
        animator.SetTrigger(Roar_Hash);
        Factory.Instance.GetBossAttack4(new Vector3(sender.transform.position.x, 0, sender.transform.position.z + 2));
